...
func (*BasicMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_basic_15fd6f3d63ea260b, []int{0}
}
...
func NewPopulatedBasicMessage(r randyBasic, easy bool) *BasicMessage {
	...
	if !easy && r.Intn(10) != 0 {
		this.XXX_unrecognized = randUnrecognizedBasic(r, 2)
	}
	return this
}
...
func init() {
	proto.RegisterFile("examples/basic/messages/basic.proto", fileDescriptor_basic_15fd6f3d63ea260b)
}

var fileDescriptor_basic_15fd6f3d63ea260b = []byte{
	...
	0x72, 0x8c, 0x0f, 0x1e, 0xc9, 0x31, 0xce, 0x78, 0x2c, 0xc7, 0x90, 0xc4, 0x06, 0x36, 0xde, 0x18,
	0x10, 0x00, 0x00, 0xff, 0xff, 0x78, 0x48, 0xc6, 0x5f, 0xb3, 0x00, 0x00, 0x00,
}
