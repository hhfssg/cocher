...
import (
	...
	"github.com/cocher/examples/topologies/messages"
...
func setupNodes(ports []int) ([]*network.Network, []*MockComponent, error) {
	...
	for i, port := range ports {
		...
		// Attach mock Component.
		Components = append(Components, new(MockComponent))
...
func broadcastTest(t *testing.T, nodes []*network.Network, processors []*MockComponent, peers map[string]map[string]struct{}, sender int) {
